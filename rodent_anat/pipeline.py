...
def run_anat_pipeline(options):
    ...
    with working_dir(outdir):
        ...
        if options.nonlinreg == "ants":
            ...
            fsl.concatxfm("ANTs/ANTs_T2_to_templ_affine_flirt.mat", "T2_to_templ_linear.mat", omat="ANTs/T2_to_templ_linear_x2.mat")
        ...
        fsl.fast("T2_brain_ud", out="seg/fast/T2_brain_P", t=2, n=3, a="transforms/templ_to_T2_linear.mat", A=[map_CSF, map_GM, map_WM], P=True)
