...
def run_anat_pipeline(options):
    ...
    with working_dir(outdir):
        ...
        if options.nonlinreg == "ants":
            ...
            LOG.info(" - Generating inverse of warp")
            fsl.invwarp("mmorf/T2_to_templ_warp", ref="T2_to_templ_linear", out="mmorf/templ_to_T2_warp")

            T2_to_templ_warp = "mmorf/T2_to_templ_warp"
            templ_to_T2_warp = "mmorf/templ_to_T2_warp"
        ...
        fsl.applywarp(templmask, ref="T2_reorient_ud", out="T2_mask", warp=templ_to_T2_warp, interp="nn")
        ...
        fsl.applywarp("T2_brain_ud", ref=templbrain, out="T2_brain_ud_to_templ", warp=T2_to_templ_warp)
        ...
        fsl.applywarp(map_CSF, ref="T2_brain_ud", out="seg/atlas/T2_brain_ud_CSF", warp=templ_to_T2_warp, interp="trilinear")
        fsl.applywarp(map_WM, ref="T2_brain_ud", out="seg/atlas/T2_brain_ud_WM", warp=templ_to_T2_warp, interp="trilinear")
        fsl.applywarp(map_GM, ref="T2_brain_ud", out="seg/atlas/T2_brain_ud_GM", warp=templ_to_T2_warp, interp="trilinear")
